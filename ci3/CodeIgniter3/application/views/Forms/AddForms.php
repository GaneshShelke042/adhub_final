...
<body>
                    ...
                    <form method="POST" id="sample-form">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea id="description-textarea" name="description" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
    ...
    <select class="form-control" name="permissions[]" id="permissions">
        ...
        function toggleSlider(slider, index) {
    slider.classList.toggle('on-right');
    updateRequireValue(index);
}

function updateRequireValue(index) {
    var slider = document.querySelector(`#require-checkbox-${index}`);
    var requireValue = slider.checked ? 1 : 0;
    document.getElementById(`require-value-${index}`).value = requireValue;
}
...
function removeOption(index) {
    selectedOptions.splice(index, 1); // Remove the option from the array
    displaySelectedOptions(); // Redisplay the selected options
}
