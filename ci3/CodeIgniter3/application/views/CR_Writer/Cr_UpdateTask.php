...
<body>
    <div class="container-fluid px-3 mb-2 " id="first-row">
        <div class="row justify-content-between p-2" id='headingrow'>
            ...
            <div class="col-sm-2 p-2 text-end">
                <a class="btn btn-primary  p-2" href="<?php

                                                        use Symfony\Component\HttpFoundation\Session\Session;

                                                        echo base_url() . 'index.php/CR_Writer/Cr_dashboardControll/viewDashboard' ?>">Close</a>
            </div>
    ...
    if (!empty($receiveddata)) {
        foreach ($receiveddata as $userData) {
            if ($userData->ticketValue == 0) { ?>

                <form method="post" action="<?php echo base_url('index.php/CR_Writer/Cr_dashboardControll/acceptTicket'); ?>">
                    <!-- accept ticket  -->
                            ...
                            <div class="d-flex mt-5 mx-2  flex-column acceptticket">
                                ...
                                <div class="col-md-8  p-3" id="controlpanel">
                                    ...
                                    <div class="buttons justify-content-center">
                                        ...
                                        ?>
                                        <input type="hidden" id="ticketValue" name="ticketValue" value="<?= $id_from_url; ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row flex-row " id="second-row">
                        ...
                        <div class="d-flex mt-5 mx-2  flex-column underflex">
                            ...
                            ?>
                            <form id="myForm" method="post" action="<?php echo base_url('index.php/CR_Writer/Cr_dashboardControll/updateTask/') . $tid ?>">
                                ...
                                <div class="col-md-8  my-5" id="controlpaneloftext">
                                    <div class="p-5 text-end">
                                        ...
                                        <input type="hidden" name="ticketValue" id="ticketValue" value="<?= $receiveddata[0]->ticketValue ?>">
                                        <input type="submit" class="btn btn-primary form-control" onclick="submitCrChanges(2,<?php echo $tid; ?>)">
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            let placeholder = document.querySelector('.note-placeholder');
