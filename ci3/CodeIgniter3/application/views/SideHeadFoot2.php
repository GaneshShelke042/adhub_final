...
<body>
  <header class="header">
    ...
    <div class="logo-details">
      ...
      <span class="logo_name" style="font-size: 25px; ">AdHub</span>
    </div>

    <i style="font-size: 25px; margin-left: 85%; margin-right: 40px;" class="bx bx-bell icons"></i>
  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/UserRoleContro/viewRoles">
