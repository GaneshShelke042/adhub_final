...
<body>
    ...
    <div class="box-container">
        ...
        <button class="add-new-button">
            <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/RoleContro/addNewRole"><i class="fas fa-plus"></i> Add New</a>
        </button>
                    ...
                    <?php if (!empty($result)) {
                        foreach ($result as $userData) { ?>
                            <tr>
                                ...
                                <td><?php echo  $userData['createdOn'] ?></td>
                                <td><?php echo  $userData['status'] ?></td>
                                <!-- <td><php echo  $userData['Action'] ?></td> -->


                                <td colspan="2" class="additional-buttons">
                                    <button class="edit">
                                        <a href="<?php echo base_url().'index.php/RoleContro/editRoles/'. $userData['id'] ?>" class="">
                                        
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </button>&nbsp;&nbsp;&nbsp;
                                    <!--button class="delete">
                                        <a href="<!?php echo base_url().'index.php/RoleContro/deleteRoles/' . $userData['id'] ?>" class="">
                                       
                                            <i class="fas fa-trash-alt"></i>
                                        </a>
                                    </button-->
                                    <button class="delete">
                                        <!-- <a href="<php echo base_url().'index.php/PackagesController/deleteData/' . $userData['id'] ?>" class=""> -->
                                        <a href="#" class="">
