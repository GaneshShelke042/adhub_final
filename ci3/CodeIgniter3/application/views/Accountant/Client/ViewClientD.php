...
<body>
    ...
    <section class="home-section" style=" margin-top: -50%;">
        ...
        <?php if ($myClientStatus === '2' || $myClientStatus === '3') { ?>
            <button class="add-new-button"><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Accountant/Acc_ClientControll/addNew_Cr_Client">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                    ...
                                    <?php if ($myClientStatus === '3') { ?>
                                        <button class="hold"> <a href="<?php echo base_url() . 'index.php/Accountant/Acc_ClientControll/editData/' . $userData['id'] ?>" class="btn btn-primary">edit </a></button> &nbsp &nbsp

                                    <?php } ?>


                                    <button class="delete"><a href="<?php echo base_url() . 'index.php/Accountant/Acc_ClientControll/deleteData/' . $userData['id'] ?>" class="btn btn-primary"> Delete </button> &nbsp &nbsp
