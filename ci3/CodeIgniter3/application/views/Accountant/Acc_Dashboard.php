...
<body>
    ...
    // echo $nameFromUrl = $this->uri->segment(5); ?>
        ...
        <section class="main-content">
            <label class="section-heading">Sales Content Writer Dashboard</label>
...
?>
                                ...
                                <?php if ($row['cr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            ...
                                            <?php include 'Acc_Cr_UpdateTask.php' ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endforeach; ?>
            ...
            <!-- Content Writer -->
            <section class="main-content">
            <label class="section-heading">Sales Graphics Desinger Dashboard</label>
            <div class="dropdown-container">
                <div class="dropdown-button">
                    <i class="fas fa-user user-icon"></i> All
                    <i class="fas fa-chevron-down"></i>
...
?>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['gr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            <!-- Popup content goes here -->
                                            <?php include 'Acc_Gr_UpdateTask.php' ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endforeach; ?>
        ...
        <section class="main-content">
            <label class="section-heading">Sales SMM Dashboard</label>
            <div class="dropdown-container">
                <div class="dropdown-button">
                    <i class="fas fa-user user-icon"></i> All
                    <i class="fas fa-chevron-down"></i>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['smm_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            <!-- Popup content goes here -->
                                            <?php include 'Acc_Smm_UpdateTask.php' ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endforeach; ?>
