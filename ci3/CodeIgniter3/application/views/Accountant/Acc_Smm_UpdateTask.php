            ...
            <form id="myForm" method="post" action="<?php echo base_url('index.php/Accountant/Acc_dashboardControll/updateTask'); ?>">
                ...
                <div class="cont">
                    ...
                    <div class="custom-button-container">
                        ...
                        <button class="custom-button" type="button" style="background-color: Blue;" onclick="submitSmmChanges(2, '<?php echo urlencode($row['id']); ?>')">iN Review</button>
                        <button class="custom-button" type="button" style="background-color: yellowgreen;" onclick="submitSmmChanges(4, '<?php echo urlencode($row['id']); ?>')">Changes</button>
                        <button class="custom-button" type="button" style="background-color: indianred;" onclick="submitSmmChanges(6, '<?php echo urlencode($row['id']); ?>')">Approve by Hand</button>
                        <button class="custom-button" type="button" style="background-color: green;" onclick="submitSmmChanges(7, '<?php echo urlencode($row['id']); ?>')">Send To Client</button>
                        <button class="custom-button" type="button" style="background-color: indianred;" onclick="submitCrChanges(3, '<?php echo urlencode($row['id']); ?>')">Cr_change</button>
                        <button class="custom-button" type="button" style="background-color: pink;" onclick="submitGrChanges(3, '<?php echo urlencode($row['id']); ?>')">Gr_change</button>
                    </div>
