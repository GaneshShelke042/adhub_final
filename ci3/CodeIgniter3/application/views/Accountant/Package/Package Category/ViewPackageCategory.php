                        ...
                        foreach ($result as $userData) { ?>
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                        ...
                                        <a class="edit" onclick="showPop(<?php echo  $userData['id'] ?>)" data-toggle="modal" data-target="#exampleModal"  >
                                        ...
                                        <!-- 
                                    <button class="edit">
                                        <a href="<php echo base_url() . 'index.php/PackageContro/updateData/' . $userData['id'] ?>" class="btn btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </button> -->
                                        ...
                                        <button class="delete">
                                            <a href="<?php echo base_url() . 'index.php/Accountant/Acc_PackageContro/deleteData/' . $userData['id'] ?>" class="btn btn-primary">
