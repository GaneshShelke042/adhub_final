...
<body>
    <section class="home">
        <div class="body">
            <div class="sub-body">
                <form method="POST" name="AddNewClient" enctype="multipart/form-data" action="<?php echo base_url() .'index.php/TaskCategoryContro/updateData/' . $userData['id']; ?>">
                    ...
                    <div class="input-field-1" style="float:left">
                        <label for="image">Upload Image:
                            <div class="image-upload">
                                ...
                                <img class="uploaded-image" id="input-field" src="<?= base_url('./Image/PackageServies/' . $userData['image']) ?>" alt="Uploaded Image">
                            </div>
                        </label> 
                    </div>
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field" style="width: 50%;  padding-left: 30px;">
                            <label>Name</label>
                            <input type="text" name="name" placeholder="Enter your name" value="<?php echo $userData['name']; ?>" required>
                        </div>
                        ...
                        <div class="input-field" style="width: 50%; padding-left: 25px;">
                        ...
                        <div class="input-field" style="width: 50%;  padding-left: 30px;">
                            ...
                            <input type="number" name="deadline" placeholder="Enter your Deadline" value="<?php echo $userData['deadline']; ?>" required>
                        </div>
                            ...
                            <select id="form" name="form">
                                ...
                                if (!empty($forms)) {
                                    ...
                                    foreach ($forms as $form) {
                                        if ($form['name'] != $previousName) {
                                            $selected = ($userData['form'] == $form['name']) ? 'selected' : '';
                                            echo '<option value="' . $form['name'] . '" ' . $selected . '>'  . $form['name'] . '</option>';
                                        }
                        ...
                        <div>
                            ...
                            <div class="fields">
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>CW(₹)</label>
                                    <input type="text" name="CW" placeholder="" value="<?php echo $userData['cw']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HCW(₹)</label>
                                    <input type="text" name="HCW" placeholder="" value="<?php echo $userData['hcw']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>GD(₹)</label>
                                    <input type="text" name="GD" placeholder="" value="<?php echo $userData['gd']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HGD(₹)</label>
                                    <input type="text" name="HGD" placeholder="" value="<?php echo $userData['hgd']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>SMM(₹)</label>
                                    <input type="text" name="SMM" placeholder="" value="<?php echo $userData['smm']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HSMM(₹)</label>
                                    <input type="text" name="HSMM" placeholder="" value="<?php echo $userData['hsmm']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>TI(₹)</label>
                                    <input type="text" name="TI" placeholder="" value="<?php echo $userData['ti']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HTI(₹)</label>
                                    <input type="text" name="HTI" placeholder="" value="<?php echo $userData['hti']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>Admin(₹)</label>
                                    <input type="text" name="Admin" placeholder="" value="<?php echo $userData['admin']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>SE(₹)</label>
                                    <input type="text" name="SE" placeholder="" value="<?php echo $userData['se']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HSE(₹)</label>
                                    <input type="text" name="HSE" placeholder="" value="<?php echo $userData['hse']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>TC(₹)</label>
                                    <input type="text" name="TC" placeholder="" value="<?php echo $userData['tc']; ?>" id="salesExecutive">
                                </div>
                                <div class="input-field" style="width: 15%; padding-left: 30px;">
                                    <label>HTC(₹)</label>
                                    <input type="text" name="HTC" placeholder="" value="<?php echo $userData['htc']; ?>" id="salesExecutive">
                                </div>
...
document.getElementById("image").addEventListener("change", function(event) {
    ...
    if (selectedFile) {
        ...
        document.getElementById("input-field-1").src = imageURL;
    }
});
                        function updateSlug() {
