...
<body>
    <section class="home">
        <div class="body">
            <div class="sub-body">
                <form method="post" name="AddNewClient" enctype="multipart/form-data" action="<?php echo base_url() . 'index.php/TaskCategoryContro/addTaskCategory' ?>">
                    <span class="close-pop" onclick="closePopup()">&times;</span>
                    <div class="input-field-1" style="float:left">
                        <label for="image">Upload Image:
                            <div class="image-upload" style="height: 100%;">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field" style="width: 50%;  padding-left: 30px;">
                            ...
                            <input type="number" name="deadline" placeholder="Enter your Deadline" required>
                        </div>
                        ...
                        <div class="input-field" style="width: 50%; padding-left: 25px;">
                            ...
                            <select id="size" name="size">
                                ...
                                <?php if (!empty($result)) {
                                    foreach ($result as $userData) {
                                        // Output each option with the value and label from the database
                                        echo '<option value="' . $userData['size'] . '">' . $userData['size'] . '</option>';
                                    }
                                }
                                ?>
                            </select>
