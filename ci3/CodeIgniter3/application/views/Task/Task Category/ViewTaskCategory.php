...
<body>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                        ...
                                        <div id="popupContainer1<?php echo $userData['id'] ?>" class="container-popup1">
                                            <div class="popup">
                                                <?php include 'EditCustomTask.php'; ?>
                                            </div>
                                        </div>
                                        ...
                                        <button class="delete" onclick="confirmDelete(<?php echo $userData['id']; ?>, '<?php echo base_url() . 'index.php/TaskCategoryContro/deleteData/' . $userData['id'] ?>')">
    ...
    function confirmAction(id, status) {
        ...
        if (confirm("Are you sure you want to make this action?")) {
            ...
            window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/TaskCategoryContro/status?id=" + id + "&status=" + status;
        }
    }
