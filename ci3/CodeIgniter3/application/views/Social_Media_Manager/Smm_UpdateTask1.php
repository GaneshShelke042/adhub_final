                            ...
                            <div class="col-md-8  mb-5" id="controlpaneloftext">
                                ...
                                <div class="border-top mb-2">
                                    ...
                                    <form id="myForm" method="post" action="<?php echo base_url('index.php/SMM/Smm_dashboardControll/updateSmmTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="Smm_ticketValue" id="Smm_ticketValue" value="<?= $receiveddata[0]->Smm_ticketValue ?>">
                                        <input type="hidden" name="tid" value="<?php echo $tid ?>">
                                        ...
                                        <div class="d-flex p-3 justify-content-end" id="buttonsss">
                                            <button class="btn btn-success m-2 " onclick="submitSmmChanges(6, '<?= $tid ?>')">Send
                                                to Client</button>
                                            <button class="btn btn-success m-2 " onclick="submitSmmChanges(7,'<?= $tid ?>')">Cr-Changes</button>
                                            <button class="btn btn-success m-2 " onclick="submitSmmChanges(8,'<?= $tid ?>')">Gr-Changes</button>
