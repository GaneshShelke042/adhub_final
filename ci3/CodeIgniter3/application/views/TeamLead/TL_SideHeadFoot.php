...
<body>
  <header class="header">
    ...
    <i style="font-size: 25px; margin-left: 55%; margin-right: 40px;" class="bx bx-bell icons"></i>
  ...
  <div class="sidebar">
    ...
    <div class="logo-details">
      ...
      <span class="logo_name">AdHub</span>
    </div>
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_ClientControll/clientView">
      ...
      <li>
        <a href="<?php echo base_url() ?>index.php/TeamLead/TL_Groupchat/groupview">
          <i class='bx bx-conversation'></i>
          <span class="link_name">Group Chat</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="<?php echo base_url() ?>index.php/TeamLead/TL_Groupchat/groupview">Group Chat</a></li>
        </ul>
      </li>
        ...
        <li>
          ...
          <ul class="sub-menu">
            ...
            <?php if ($myPackage_Category === '1' || $myPackage_Category === '2' || $myPackage_Category === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_PackageContro/viewpackage">Package
                  Category</a></li>
            <?php } ?>

            <?php if ($myPackage_GST === '1' || $myPackage_GST === '2' || $myPackage_GST === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_Package_GSTContro/viewpackage">Package
                  GST</a></li>
            <?php } ?>

            <?php if ($myPackage_Service === '1' || $myPackage_Service === '2' || $myPackage_Service === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_PackageServicesController/viewpackage">Package
                  Service</a></li>
            <?php } ?>

            <?php if ($myPackage === '1' || $myPackage === '2' || $myPackage === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_PackagesController/viewPackage">Package
                </a></li>
            <?php } ?>
