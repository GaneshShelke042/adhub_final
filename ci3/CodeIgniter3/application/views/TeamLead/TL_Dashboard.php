...
.box {
    height: 130px;
    width: calc(16.3% - 15px); /* Adjust width for smaller screens */
    max-width: 250px; /* Set max-width to limit size on larger screens */
    border-radius: 20px;
    box-shadow: 3px 3px 10px rgba(0, 30, 87, 0.751);
    padding-right:40px;
    padding-left:20px;
    ...
    // echo $nameFromUrl = $this->uri->segment(5); ?>
        ...
        <div class="main"> 
            <div class="box-container">
                <P style="margin: left 60px;">Team Lead Content Writer Dashboard</p>
            ...
            <div class="box-container"> 
                    ...
                    ?>
                        ...
                        if ($myDashboardStatus !== null) {
                            ...
                            foreach ($statusParts as $statusPart) {
                                $statusPart = trim($statusPart);
                                if ($statusPart === "Approved_by_Hand") { 
                                ?>
                        ...
                        if ($myDashboardStatus !== null) {
                            ...
                            foreach ($statusParts as $statusPart) {
                                ...
                                if ($statusPart === "Approved_by_Client") {
                                    ?>
                                    <button class="button button5 button-with-underline cr box topic-heading" onclick="toggleUrgentButtons(8); toggleActive(this);">Final Done<span id="ApprovedbyClient" class="urgent-count"></span><i class="fas fa-check-circle"></i></button>
...
if ($myDashboardStatus !== null) { // Split the $myDashboardStatus string into an array based on commas
                        ...
                        foreach ($statusParts as $statusPart) { // Trim any leading or trailing whitespace from the status part
                            ...
                            if ($statusPart === "All") { // Change 'Urgent' to the condition you want to match
                    ?>
                             ...
                             <?php if ($row['Client_id'] == $data['id'] && $data['status'] == 1 ) : ?>
                                <?php if ($row['cr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/TeamLead/TL_dashboardControll/updateTask/' . $row['id'] ?>" class="popup-trigger">
                                        <!-- <button class="<!?php echo $borderClass; ?>"  data-cr-status="<!!?php echo $row['cr_Status']; ?>"> -->
                                        <!-- <img src="<!?php echo base_url()?>Image/PackageServies/<!?php echo $row['imageLogo']; ?>" > -->
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            ...
                                            <a href="<?php echo base_url() . 'index.php/TeamLead/TL_dashboardControll/updateTask/' . $row['id'] ?>" class="btn btn-primary">
        ...
        <div class="main">     
            <div class="box-container"> 
                <P style="margin: left 60px;">Team Lead Graphics Desinger Dashboard</p>
                ...
                <?php
                    ...
                    if ($myDashboardStatus !== null) {
                        ...
                        foreach ($statusParts as $statusPart) {
                            ...
                            if ($statusPart === "Urgent") {
                                ?>
                               <button class="button button2 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(1) ; toggleActive(this);"> Urgent<span id="urgentCountgr" class="urgent-count"></span> <i class="fas fa-exclamation-circle"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Changes") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button3 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(4) ; toggleActive(this);">Changes<span id="chagesgr" class="urgent-count"></span><i class="fas fa-sync-alt fa-spin" style='font-size:24px'></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Rewrite") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button4 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(5) ; toggleActive(this);">Rewrite<span id="InReviewcountgr" class="urgent-count"></span><i class="fa fa-check-square-o"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "reassigned") { // Change 'Urgent' to the condition you want to match
                            ?>
                             <button class="button button10 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(9) ; toggleActive(this);">Reassigned<span id="Reassignedgr" class="urgent-count"></span><i class="fas fa fa-upload"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Today") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button9 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(3) ; toggleActive(this);">Today <span id="Todaygr" class="urgent-count"></span><i class="far fa-calendar-alt"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "In_Review") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button8 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(2) ; toggleActive(this);"> In Review <span id="Rewritegr" class="urgent-count"></span><i class="fas fa-random" style='font-size:22px'></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Approved_by_Hand") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button7 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(6) ; toggleActive(this);">Approved by Head<span id="Approvedbyheadgr" class="urgent-count"></span><i class="fas fa-thumbs-up"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Send_To_Client") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button6 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(7) ; toggleActive(this);">Send to Client<span id="SendtoClientgr" class="urgent-count"></span><i class="fas fa-paper-plane"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Approved_by_Client") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button5 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(8) ; toggleActive(this);">Final Done<span id="ApprovedbyClientgr" class="urgent-count"></span><i class="fas fa-check-circle"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Advance") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button11 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(10) ; toggleActive(this);">Advance<span id="Advancegr" class="urgent-count"></span><i class="fas fa-edit"></i></button>
                    ...
                    foreach ($statusParts as $statusPart) {
                        ...
                        if ($statusPart === "Hold") { // Change 'Urgent' to the condition you want to match
                            ?>
                            <button class="button button12 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(11) ; toggleActive(this);">Hold<span id="Holdgr" class="urgent-count"></span><i class="fas fa-pause"></i></button>
...
if ($myDashboardStatus !== null) { // Split the $myDashboardStatus string into an array based on commas
                             ...
                             <?php foreach ($matchedClients as $row) : ?>
                                ...
                                <?php if ($row['gr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                        <!-- // Inside your PHP loop to generate ticket buttons -->
                                        <a href="<?php echo base_url() . 'index.php/TeamLead/TL_DashboardControll/updateGRTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            <!-- Popup content goes here -->
                                            <a href="<?php echo base_url() . 'index.php/TeamLead/TL_DashboardControll/updateGRTask/' . $row['id'] ?>" class="btn btn-primary">
                                                <!-- <php include 'UpdateTask1.php' ?> -->
                                            </a>
                                        </div>
                                        </div>
        ...
        <div class="main"> 
            <div class="box-container">     
                <label class="section-heading">Team Lead SMM Dashboard</label>
                <div class="dropdown-container">
                    <div class="dropdown-button">
                        <i class="fas fa-user user-icon"></i> All
                        <i class="fas fa-chevron-down"></i>
            ...
            foreach ($statusParts as $statusPart) {
                ...
                if ($statusPart === "Changes") { // Change 'Urgent' to the condition you want to match
                    ?>
                    <button class="button button4 box topic-heading" onclick="toggleSmmButtons(8)">Gr-Changes<span id="Changessmmgr" class="urgent-count">0</span><i class="fas fa-exchange-alt"></i></button> 
                    <?php
                    // Break the loop if you want to display the button only once
                    break;
                }
            ...
            foreach ($statusParts as $statusPart) {
                ...
                if ($statusPart === "Advance") { // Change 'Urgent' to the condition you want to match
                    ?>
                    <button class="button button11 box topic-heading" onclick="toggleSmmButtons(3)">Advance<span id="Advancesmm" class="urgent-count">0</span><i class="fas fa-exchange-alt"></i></button> 
                    <?php
                    // Break the loop if you want to display the button only once
                    break;
                }
            ...
            foreach ($statusParts as $statusPart) {
                ...
                if ($statusPart === "Hold") { // Change 'Urgent' to the condition you want to match
                    ?>
                    <button class="button button12 box topic-heading" onclick="toggleSmmButtons(4)">Manual<span id="Manualsmm" class="urgent-count">0</span><i class="fas fa-arrow-up"></i></button>
                    <?php
                    // Break the loop if you want to display the button only once
                    break;
                }
                             ...
                             <?php foreach ($matchedClients as $row) : ?>
                                ...
                                <?php if ($row['smm_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                        <!-- // Inside your PHP loop to generate ticket buttons -->
                                        <a href="<?php echo base_url() . 'index.php/TeamLead/TL_DashboardControll/updateSmmTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" >
                                            <!-- Popup content goes here -->
                                            <a href="<?php echo base_url() . 'index.phpTeamLead/TL_DashboardControll/updateSmmTask/' . $row['id'] ?>" class="btn btn-primary">
    ...
    <script>
         document.addEventListener('DOMContentLoaded', function()    
        {
            ...
            updateInReviewcountgr(reviewgr)
            updatechangecountgr(changegr)
            updateRewritecountgr(Rewritegr)
...
// graphics
        ...
        function updateInReviewcountgr(count) {
            let InReviewcount = document.getElementById('Rewritegr');
            InReviewcount.textContent = count;
        }
        ...
        function updateRewritecountgr(count) {
            let Rewrite = document.getElementById('InReviewcountgr');
            Rewrite.textContent = count;
        }
