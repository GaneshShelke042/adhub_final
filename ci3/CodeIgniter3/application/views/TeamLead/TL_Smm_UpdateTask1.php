...
<body>
    ...
    if (!empty($receiveddata)) {
        foreach ($receiveddata as $userData) {
            if ($userData->TL_SMM_TicketValue == 0) { ?>

                <form method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/acceptTicketSMM'); ?>">
                    <!-- accept ticket  -->
                            ...
                            <div class="d-flex mt-5 mx-2  flex-column acceptticket">
                                ...
                                <div class="col-md-8  p-3" id="controlpanel">
                                    ...
                                    <div class="buttons justify-content-center">
                                        ...
                                        ?>
                                        <input type="hidden" id="ticketValue" name="TL_SMM_TicketValue" value="<?= $id_from_url; ?>">
                    ...
                    <div class="row flex-row " id="second-row">
                        <div class="d-flex mt-5 mx-2  flex-column underflex" id="base">
                            ...
                            <div class="col-md-8  p-3" id="controlpanel">
                                ...
                                <div class="buttons justify-content-center">
                                    <button class="btn btn-danger m-1" onclick="question54()">
                                        54 Questions
                                    </button>
                                    ...
                                    <button class="btn btn-danger m-1" onclick="questionpainpoint()">
                                        Pain Point
                                    </button>
                                    ...
                                    <button class="btn btn-danger m-1" onclick="language()">
                                        Language
                                    </button>
                                    ...
                                    <button class="btn btn-danger m-1" onclick="questionoffer()">
                                        Offer
                                    </button>
                        ...
                        <div class="d-flex mt-5 mx-2  flex-column underflex">
                            ...
                            <div class="col-md-8  mb-5" id="controlpaneloftext">
                                ...
                                <form id="myForm" method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/updateSmmTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="border-top mb-2">
                                        ...
                                        <input type="hidden" name="tid" value="<?php echo $tid ?>">
                                        <div class="d-flex p-3 justify-content-center" id="buttonsss">
                                            <button class="btn btn-success m-2 " onclick="submitSmmChanges(6, '<?= $tid ?>')">Send
                                                to Client</button>
                                            <button class="btn btn-success m-2 " onclick="submitCrChanges(<?= $tid ?>)">Changes
                                                CW</button>
                                            <button class="btn btn-success m-2 " onclick="submitGrChanges(<?= $tid ?>)">Changes
                                                GD</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            myForm.addEventListener('submit', function(event) {
                ...
                document.getElementById('newsummernote').value = document.getElementsByClassName(
        ...
        function submitCrChanges(cr_Status, tid) {
            ...
            document.getElementById('cr_Status').value = 4;
            document.getElementById('smm_Status').value = 7;
        ...
        function submitGrChanges(gr_Status, tid) {
            document.getElementById('gr_Status').value = 4;
            document.getElementById('smm_Status').value = 8;
            document.getElementById('tid').value = tid;
            // Submit the form
            myForm.submit();
        }
