                                ...
                                if (!empty($insentive)) {
                                    foreach ($insentive as $userData) {
                                        ...
                                        if ($userData['name'] === $cleanedTaskName) {
                                            ...
                                            echo $userData['smm']; // or any other action you want to perform
                ...
                <div class="col-md-6">
                    <div id="setofbutton">
                        ...
                        <div class="custom-button-container d-flex justify-content-center py-5">
                            ...
                            <button class="custom-button" style="background-color: palevioletred;" onclick="submitSmmChanges(2, '<?php $tid ?>')">Rewrite</button>
