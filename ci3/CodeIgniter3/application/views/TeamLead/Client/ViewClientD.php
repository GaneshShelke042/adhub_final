...
<body>
    ...
    <div class="main-content">
        ...
        <?php if ($myClientStatus === '2' || $myClientStatus === '3') { ?>
            ...
            <a class="add-new-button" href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_ClientControll/addNew_Cr_Client">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                    ...
                                    <?php if ($myClientStatus === '3') { ?>
                                        <button class="edit"> <a href="<?php echo base_url() . 'index.php/TeamLead/TL_ClientControll/editData/' . $userData['id'] ?>" class="btn btn-primary"><i class="fa fa-edit" style="font-size:20px" ></i> </a></button> &nbsp &nbsp

                                    <?php } ?>


                                    <button class="delete"><a href="<?php echo base_url() . 'index.php/TeamLead/TL_ClientControll/deleteData/' . $userData['id'] ?>" class="btn btn-primary"><i class="fa fa-trash-o" style="font-size:20px"></i></button> &nbsp &nbsp
                                    <button class="permission"> <a href="<?php echo base_url() . 'index.php/TeamLead/TL_UpdateClientPermissionContro/TL_UpdateClientPermissionContro/' . $userData['id'] ?>" class="btn btn-primary"><i class="fa fa-shield" style="font-size:20px"></i></a> </button>&nbsp &nbsp &nbsp
                                    <button class="hold">
                                        <a href="<?php echo base_url() . 'index.php/TeamLead/TL_UpdateClientContro/viewCalender/' . $userData['id']; ?>" class="btn btn-primary">
