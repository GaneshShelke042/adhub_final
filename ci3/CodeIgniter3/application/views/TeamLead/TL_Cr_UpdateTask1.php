...
<body>
    ...
    if (!empty($receiveddata)) {
        foreach ($receiveddata as $userData) {
            if ($userData->TL_TicketValue == 0) { ?>

                <form method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/acceptTicketCR'); ?>">
                    <!-- accept ticket  -->
                            ...
                            <div class="d-flex mt-5 mx-2  flex-column acceptticket">
                                ...
                                <div class="col-md-8  p-3" id="controlpanel">
                                    ...
                                    <div class="buttons justify-content-center">
                                        ...
                                        ?>
                                        <input type="hidden" id="ticketValue" name="TL_TicketValue" value="<?= $id_from_url; ?>">
                            ...
                            <form id="myForm" method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/updateTask/') ?>">
                                ...
                                <div class="col-md-8  my-5" id="controlpaneloftext">
                                    ...
                                    <div class="  buttonsofassigning">
                                        ...
                                        <button class="btn  button m-2 " id="rewrite">Re Write</button>
                                        ...
                                        <button class="btn  button m-2 " id="sendtographic" onclick="submitGrChanges(1, <?php echo $tid; ?>), submitCrChanges(8, <?php echo $tid; ?>)">Send to Graphics</button>
                                    </div>
                                </div>
                            </form>
