...
<body>
    <section class="home-section">
        ...
        <button class="add-new-button">
            <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/TeamLead/TL_PackageServicesController/addnewpackage"><i class="fas fa-plus"></i> Add New</a>
        </button>
                        ...
                        foreach ($result as $userData) { ?>
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                    <button class="edit">
                                        <a href="<?php echo base_url().'index.php/TeamLead/TL_PackageServicesController/updateData/'.$userData['id']?>" class="">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </button>&nbsp;&nbsp;&nbsp;
                                    <button class="details">
                                        <a href="<?php echo base_url().'index.php/TeamLead/TL_PackageServicesController/deleteData/'.$userData['id']?>" class="">
