...
<body>
    <section class="home-section">
        ...
        <button class="add-new-button">
            <a href="<?php echo base_url() ?>index.php/TeamLead/TL_Groupchat/add"><i class='bx bxs-message-alt-add'></i>ADD</a>
        </button>
                ...
                <tbody>
                    ...
                    if (!empty($values)) {
                        foreach ($values as $key) {
                            ...
                            echo "<td><a href='" . base_url() . "index.php/TeamLead/TL_Groupchat/update/$key' class='btn btn-primary'><i class='bx bxs-message-alt-edit'></i></a></td>"; // Add your Actions column data here
                            //  Add your Actions column data here
                            echo "<td><a href='" . base_url() . "index.php/TeamLead/TL_Groupchat/View/$key' class='btn btn-info'><i class='bx bxs-low-vision' ></i></a></td>"; // Add your Actions column data here
                            echo "</tr>";
                        }
                    } else {
                    ?>
    ...
    <script>
        ...
        function changeHappen() {
            ...
            let url = `<?= base_url() ?>index.php/TeamLead/TL_Groupchat/ChangeStatus`;
