...
<body>
        ...
        <div class="conatiner p-2">
            <div class="row justify-content-end ">
                <div class="col-md-2 p-2">
                    <a href="<?php echo base_url() ?>index.php/TeamLead/TL_Groupchat/Manage" class="btn btn-primary mx-2"><i class='bx bxs-message-edit mx-2'></i>Manage</a>
                </div>
            </div>
    ...
    <script>
        ...
        function openchatbox(str, id, image) {
            ...
            let url = `<?= base_url() ?>index.php/TeamLead/TL_Chat/show/${groupid}`;
            console.log(url);
            fetch(url)
                .then(response => {
                    if (!response.ok) {
        ...
        sendmessage.addEventListener('click', () => {
            ...
            console.log(message);
            let url = `<?= base_url() ?>index.php/TeamLead/TL_Chat/add`;
            console.log(url);
            // ul.style.zIndex = 99;
        ...
        function deleteMessage(messageId) {
            ...
            fetch(`<?= base_url() ?>index.php/TeamLead/TL_chat/delete/${messageId}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
