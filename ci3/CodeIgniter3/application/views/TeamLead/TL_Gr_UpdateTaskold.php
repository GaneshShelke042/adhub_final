                                ...
                                if (!empty($insentive)) {
                                    foreach ($insentive as $userData) {
                                        ...
                                        if ($userData['name'] === $cleanedTaskName) {
                                            ...
                                            echo $userData['gd']; // or any other action you want to perform
                ...
                <div class="col-md-6">
                    <div id="setofbutton">
                        ...
                        <div class="custom-button-container d-flex justify-content-center py-5">
                            <button class="custom-button" style="background-color: palevioletred;" onclick="submitGrChanges(2, '<?php $tid ?>')">Rewrite</button>
                            
                            <button class="custom-button" style="background-color: palevioletred;" onclick="openPopup('<?php echo $tid ?>')">Re-Assign</button>

                            <button class="custom-button" style="background-color: yellowgreen;" onclick="submitGrChanges(4, '<?php $tid ?>')">Changes</button>
                            <button class="custom-button" style="background-color: indianred;" onclick="submitGrChanges(6, '<?php $tid ?>>')">Approve</button>
                            <button class="custom-button" style="background-color: green;" onclick="submitGrChanges(7, '<?php $tid ?>')">Send To Client</button>
                            <button class="custom-button" style="background-color: pink;" onclick="submitSmmChanges(1, '<?php $tid ?>')">Send To SMM </button>
...
function openPopup(tid) {
    // Your logic to open the popup here
    // For example, you can use window.open() to open a new window or show a modal
    // For simplicity, let's alert the tid value
    alert('Ticket ID: ' + tid);
}
