...
<body>
    ...
    if (!empty($receiveddata)) {
        foreach ($receiveddata as $userData) {
            if ($userData->TL_GD_TicketValue == 0) { ?>

                <form method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/acceptTicketGD'); ?>">
                    <!-- accept ticket  -->
                            ...
                            <div class="d-flex mt-5 mx-2  flex-column acceptticket">
                                ...
                                <div class="col-md-8  p-3" id="controlpanel">
                                    ...
                                    <div class="buttons justify-content-center">
                                        ...
                                        ?>
                                        <input type="hidden" id="ticketValue" name="TL_GD_TicketValue" value="<?= $id_from_url; ?>">
                ...
                <div class="container-fluid px-3 mb-2 " id="first-row">
                    <div class="row justify-content-between p-2" id='headingrow'>
                        ...
                        <div class="col-sm-2 p-2 text-end">
                            <a class="btn btn-primary  p-2" href="<?php echo base_url() . 'index.php/TeamLead/TL_dashboardControll/viewDashboard' ?>">Close</a>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row flex-row " id="second-row">
                        ...
                        <div class="d-flex mt-5 mx-2  flex-column underflex">
                            ...
                            <form id="myForm" method="post" action="<?php echo base_url('index.php/TeamLead/TL_dashboardControll/updateGRTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8  my-5" id="controlpaneloftext">
                                    ...
                                    <div class="  buttonsofassigning">
                                        ...
                                        <button class="btn  button m-2 " id="reDesign">ReDesign</button>
                                        ...
                                        <button class="btn  button m-2 " id="sendtosmm" onclick="submitSmmChanges(1, '<?= $tid ?>')">Send to SMM</button>
                                    </div>
