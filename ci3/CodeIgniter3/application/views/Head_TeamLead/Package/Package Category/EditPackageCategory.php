    ...
    <section class="home">
        <div class="body">
            <div class="sub-body">
                ...
                <form method="post" action="<?php echo site_url('index.php/Head_Team_Lead/Head_TL_PackageContro/updateData/'.$userData['id']); ?>">
                    <span class="close-pop" onclick="closePop()">&times;</span>
