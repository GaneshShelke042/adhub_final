...
<body>
    ...
    <div class="custom-container">
        <section class="content-section">
            ...
            <form id="myForm" method="post" action="<?php echo base_url('index.php/Head_Team_Lead/Head_TL_dashboardControll/updateTask'); ?>">
                ...
                <input type="hidden" name="name" id="name" value=" <?php echo urlencode($row['id']); ?>">
                ...
                <!-- <input type="textarea" name="editor_content" id="editor_content"> -->
                <!-- <input type="text" name="name" > -->
                <div class="cont">
                    <div id="editor" contenteditable="true" name="editor_content" >
                        <section id="toolbar">
                    ...
                    <div class="custom-button-container">
                        ...
                        <button class="custom-button" type="button" style="background-color: palevioletred;" onclick="submitCrChanges(2, '<?php echo urlencode($row['id']); ?>')">in review</button>
                        <button class="custom-button" type="button" style="background-color: yellowgreen;" onclick="submitCrChanges(4, '<?php echo urlencode($row['id']); ?>')">Changes</button>
                        <button class="custom-button" type="button" style="background-color: indianred;" onclick="submitCrChanges(6, '<?php echo urlencode($row['id']); ?>')">Approve by hand</button>
                        <button class="custom-button" type="button" style="background-color: green;" onclick="submitCrChanges(7, '<?php echo urlencode($row['id']); ?>')">Send To Client</button>
                        <button class="custom-button" type="button" style="background-color: pink;" onclick="submitGrChanges(1, '<?php echo urlencode($row['id']); ?>')">Send To Graphics </button>
                    </div>
        ...
        <script>
            ...
            function closePopup() {
                ...
                window.location.href = 'http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_Team_Lead/Head_TL_dashboardControll/viewDashboard';
            }
            ...
            function updateEditorContent() {
                // var editorContent = document.getElementById('name').innerHTML;
                // var nameValue = document.querySelector('input[name="name"]').value;
                document.getElementById('name').value = cr_data;
...
//             function submitCrChanges(cr_data, cr_Status, tid) {
//     // Set the value of cr_Status input field to cr_Status
//     document.getElementById('cr_Status').value = cr_Status;
...
//     // Set the value of editor_content input field to cr_data
//     document.getElementById('editor_content').value = cr_data;
