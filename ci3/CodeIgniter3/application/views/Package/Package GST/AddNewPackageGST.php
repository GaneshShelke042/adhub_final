...
<body>
    <section class="home">
        <div class="body">
            <div class="sub-body">
                <form method="post" name="AddNewClient" action="<?php echo base_url().'index.php/Package_GSTContro/addnewpackage'?>">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field" style="width: 25%; padding-left: 25px;">
                            ...
                            <input type="text" placeholder="Enter CGST" name="cgst"  oninput="calculateTotal()">
                        </div>
                        <div class="input-field" style="width: 25%; padding-left: 25px;">
                            <label for="Parent">SGST(%)</label>
                            <input type="text" placeholder="Enter SGST" name="sgst" required oninput="calculateTotal()">
                        </div>
