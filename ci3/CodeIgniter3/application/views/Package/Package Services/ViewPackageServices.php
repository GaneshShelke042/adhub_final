...
<body>
    ...
    <div class="box-container"> 
        ...
        <div class="container">
            ...
            <div class="search-container">
                ...
                <button class="add-new-button">
                    <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/PackageServicesController/addnewpackage"><i class="fas fa-plus"></i> Add New</a>
                </button>
                        ...
                        foreach ($result as $userData) { ?>
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                    <button class="edit">
                                        <a href="<?php echo base_url().'index.php/PackageServicesController/updateData/'.$userData['id']?>"  data-toggle="tooltip" title="edit" class="">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </button>&nbsp;&nbsp;&nbsp;
                                    <!-- <button class="delete">
                                        <a href="<php echo base_url().'index.php/PackageServicesController/deleteData/'.$userData['id']?>"  data-toggle="tooltip" title="delete" class="">
                                            <i class="fas fa-trash-alt"></i>
                                        </a>
                                    </button>
                                     -->
                                    <button class="delete" onclick="confirmDelete(<?php echo $userData['id']; ?>, '<?php echo base_url() . 'index.php/PackageServicesController/deleteData/' . $userData['id'] ?>')">
        <i class="fas fa-trash-alt"></i>
    </button>
        ...
        if (confirm("Are you sure you want to make this action?")) {
            ...
            window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/PackageServicesController/status?id=" + id + "&status=" + status;
        }
    }
