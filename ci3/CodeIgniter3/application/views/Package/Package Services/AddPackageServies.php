...
<body>
    <section class="home-section">
        ...
        <form method="post" name="AddNewClient" id="editorForm" enctype="multipart/form-data" style="border: 10px;" onsubmit="return confirmSubmission()">

            <div class="input-field-1" style="float:left">
                <label for="image">Upload Image:
                    <div class="image-upload">
                        <input type="file" id="image" name="image">
                        <img class="uploaded-image" id="uploaded-image" src="<?php echo base_url('img/image-gallery_3342137 (2).png'); ?>" alt="Uploaded Image">
                    </div>
                </label>
            </div>
            ...
            <div class="fields">
                ...
                <div class="input-field" style="width: 42%; padding-left: 25px;">
                    <label>Video</label>
                    <input type="text" name="vidio" placeholder="">
                </div>
                ...
                <div class="input-field" style="width: 10%; padding-left: 25px;">
                    ...
                    <label class="toggle-switch">
                        ...
                        <input type="hidden" id="toggglevalue" name="hidden_price">
            ...
            <div class="fields">
                ...
                <div class="input-field" style="width: 19%; padding-left: 25px;">
                    <label>Price</label>
                    <input type="number" name="price" placeholder="" required onchange="calculateSubtotal()">
                </div>
                <div class="input-field" style="width: 15%; padding-left: 30px;">
                    <label>Discount</label>
                    <input type="number" name="discount" placeholder="" required onchange="calculateSubtotal()">
                </div>
                <div class="input-field" style="width: 15%; padding-left: 30px;">
                ...
                <div class="input-field" style="width: 20%; padding-left: 30px;">
                    ...
                    <input type="text" name="sub-total" placeholder="" required id="sub-total" readonly>
                </div>
                    ...
                    <select id="gst" name="gst" onchange="calculateTotal()">
                        <?php if (!empty($result1)) {
                            foreach ($result1 as $userData) {
                                if ($userData['status'] == 1) {
                                    echo '<option value="' . $userData['total'] . '">' . $userData['name'] . '</option>';
                                }
                            }
                        }
                        ?>
                ...
                <div class="input-field" style="width: 30%; padding-left: 30px;">
                    <label>GST (₹)</label>
                    <input type="text" name="gst-amount" placeholder="" id="gst-amount" required onchange="updateTotal()">
                </div>
                <div class="input-field" style="width: 20%; padding-left: 30px;">
                    <label>Amount</label>
                    <input type="text" name="amount" id="amount" placeholder="" required>
                </div>

                <div class="input-field" style="width: 20%; padding-left: 30px;">
                    <label>Total</label>
                    <input type="text" name="total" placeholder="" id="total" required>
                </div>


                <div class="input-field" style="width: 20%; padding-left: 30px; margin-left: 2.5%;">
                    <label class="description">Upload Photos</label>
                    <input type="file" id="file-input" name="multipalPics[]" multiple style="background-color: #FFF;">
                </div>
                ...
                <div class="container" style=" background-color: #D5D6E2;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-12 col-lg-8">
                            ...
                            <textarea id="editor" class="editorAria" name="editor-content"></textarea>
                    ...
                    <div class="fields">
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>CW(₹)</label>
                            <input type="text" name="CW" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HCW(₹)</label>
                            <input type="text" name="HCW" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>GD(₹)</label>
                            <input type="text" name="GD" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HGD(₹)</label>
                            <input type="text" name="HGD" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>SMM(₹)</label>
                            <input type="text" name="SMM" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HSMM(₹)</label>
                            <input type="text" name="HSMM" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>TI(₹)</label>
                            <input type="text" name="TI" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HTI(₹)</label>
                            <input type="text" name="HTI" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>Admin(₹)</label>
                            <input type="text" name="Admin" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>SE(₹)</label>
                            <input type="text" name="SE" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HSE(₹)</label>
                            <input type="text" name="HSE" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>TC(₹)</label>
                            <input type="text" name="TC" placeholder="" id="salesExecutive">
                        </div>
                        <div class="input-field" style="width: 10%; padding-left: 30px;">
                            <label>HTC(₹)</label>
                            <input type="text" name="HTC" placeholder="" id="salesExecutive">
                        </div>
                ...
                <i class="uil uil-navigator"></i>
                    ...
                    <div style="text-align: center; margin-top: 20px;">
                        <button type="submit" class="submit-button" id="submitEditor" onclick="submitForm()">
                            <span>Submit</span>
                            <i class="uil uil-navigator"></i>
                        </button>
                ...
                <script>
                        ...
                        for (const file of files) {
                            ...
                            reader.onload = function(e) {
                                ...
                                deleteButton.onclick = function() {
                                    ...
                                    // Create a new files array without the deleted file
                    ...
                    document.getElementById("toggleButton").addEventListener("change", function() {
                        ...
                        document.getElementById("toggglevalue").value = value;
                        console.log(document.getElementById("toggglevalue"));

                        const toggleSlider = document.querySelector('.toggle-slider');
                        toggleSlider.classList.toggle('checked', this.checked);

                        // Here, you can send the value (1 or 0) to a server or perform any other action
                    });
                    ...
                    $(document).ready(function() {
                        var colorPalette = ['000000', 'FF9966', '6699FF', '99FF66', 'CC0000', '00CC00', '0000CC', '333333', '0066FF', 'FFFFFF'],
                            ...
                            editor = $('#editor'); // Use the correct selector
                        ...
                        $('#submitEditor').click(function(e) {
                            e.preventDefault();
                            var content = editor.html();
                            $('#description1').val(content);

                            console.log("Editor content:", content); // Debugging step
                            console.log("Hidden input value:", $('#description1').val()); // Debugging step
                    ...
                    function cancelAction() {
                        // Set the closeClicked flag to true
                        closeClicked = true;

                        // Redirect the page to the desired URL
                        window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/PackageServicesController/viewpackage";
                    }

                    function confirmSubmission() {
                        // If the close button was clicked, prevent form submission
                        if (closeClicked) {
                            return false;
                        }

                        // Allow form submission otherwise
                        return true;
                    }
                </script>
