    ...
    <div class="container-fluid px-3 mb-2 " id="first-row">
        <div class="row justify-content-between p-2" id='headingrow'>
            ...
            <div class="col-sm-2 p-2 text-end">
                <a class="btn btn-primary  p-2" href="<?php echo base_url() . 'index.php/Head_GR_Desinger/Head_Gr_dashboardControll/viewDashboard' ?>">Close</a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row flex-row " id="second-row">
            ...
            <div class="d-flex mt-5 mx-2  flex-column underflex">
                ...
                <form id="myForm" method="post" action="<?php echo base_url('index.php/Head_GR_Desinger/Head_GR_DashboardControll/updateGRTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8  my-5" id="controlpaneloftext">
                        ...
                        <div class="  buttonsofassigning">
                            ...
                            <button class="btn  button m-2 " id="hold" onclick="submitGrChanges(11, '<?= $tid ?>')">Hold</button>
                            ...
                            <button class="btn  button m-2 " id="reDesign" onclick="submitGrChanges(5, '<?= $tid ?>')">ReDesign</button>
