...
<body>
    ...
    echo $nameFromUrl = $this->uri->segment(5); ?>
        ...
        <div class="main"> 
            ...
            <P style="margin: left 60px;">Head Graphics Dashboard</P>
            ...
            <div class="box-container">
        <!-- <section class="main-content">
            <label class="section-heading">Head Graphics Dashboard</label>
            <div class="dropdown-container">
                <div class="dropdown-button">
                    <i class="fas fa-user user-icon"></i> All
                    <i class="fas fa-chevron-down"></i>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['gr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                       <a href="<?php echo base_url() . 'index.php/Head_GR_Desinger/Head_GR_DashboardControll/updateGRTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            ...
                                            <a href="<?php echo base_url() . 'index.php/Head_GR_Desinger/Head_GR_DashboardControll/updateGRTask/' . $row['id'] ?>" class="btn btn-primary">
