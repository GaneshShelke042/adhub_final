...
<body>
  <header class="header">
    ...
    <div id="urlIdDisplay">
      ...
      echo ("(Head Graphics Desinger)")
      ?>
    </div>

    <i style="font-size: 25px; margin-left: 50%; margin-right: 40px;" class="bx bx-bell icons"></i>
  ...
  <div class="sidebar ">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_GR_Desinger/Head_Gr_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_GR_Desinger/Head_Gr_ClientControll/clientView">
      ...
      <li>
        <a href="<?php echo base_url() ?>index.php/Head_GR_Desinger/Head_GR_Groupchat/groupview">
          <i class='bx bx-conversation'></i>
          <span class="link_name">Group Chat</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="<?php echo base_url() ?>index.php/Head_GR_Desinger/Head_GR_Groupchat/groupview">Group Chat</a></li>
        </ul>
      </li>
