...
<body>
    <section class="home-section">
        ...
        <div class="container">
            ...
            <form id="dynamicForm" method="post" action="<?php echo base_url() ?>index.php/Groupchat/update/<?= $id ?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-2">
                ...
                ?> -->
                        ...
                        <div>
                            ...
                            <a href="<?php echo base_url() ?>index.php/Groupchat/Manage" class="btn btn-success">Close</a>
                        </div>
