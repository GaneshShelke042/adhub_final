        ...
        <div class="conatiner p-2">
            <div class="row justify-content-end ">
                <div class="col-md-2 p-2">
                    <a href="<?php echo base_url() ?>index.php/Groupchat/Manage" class="btn btn-primary mx-2"><i class='bx bxs-message-edit mx-2'></i>Manage</a>
                </div>
            </div>
                ...
                <div class="col-md-5 mt-2" id="chat">
                    ...
                    <ul class="chatmessage my-2" id="chatmessage">
                        ...
                        <li class="sender">
                            ...
                            <p> <span class="role  ">Content Writer</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis repudiandae dolore accusantium officiis architecto enim fuga at reiciendis necessitatibus? Voluptate eligendi dolorem temporibus. Nobis deserunt quaerat velit accusamus beatae laudantium omnis et impedit, dolorum modi vel facilis quisquam magni magnam dolor a alias eum minus autem recusandae. Atque, error ex.</p> <span class="time">10:06 am</span>
                        </li>
                        <li class="repaly">
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci, rem!</p> <span class="time">10:06 am</span>
                        </li>
