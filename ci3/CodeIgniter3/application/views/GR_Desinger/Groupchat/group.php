...
<body>
    ...
    <script>
        ...
        function openchatbox(str, id, image) {
            ...
            let url = `<?= base_url() ?>index.php/GR_Desinger/Gr_Chat/show/${groupid}`;
            console.log(url);
            fetch(url)
                .then(response => {
                    if (!response.ok) {
        ...
        sendmessage.addEventListener('click', () => {
            ...
            console.log(message);
            let url = `<?= base_url() ?>index.php/GR_Desinger/Gr_Chat/add`;
            console.log(url);
            // ul.style.zIndex = 99;
        ...
        function deleteMessage(messageId) {
            ...
            fetch(`<?= base_url() ?>index.php/GR_Desinger/Gr_Chat/delete/${messageId}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
