    ...
    <?php echo $nameFromUrl = $this->uri->segment(5); ?>
      <section class="main-content">
        <div class="main"> 
            ...
            <P style="margin: left 60px;">Graphics Designer</P>
                <div class="dropdown-container">
                    ...
                    <div class="dropdown-content">
                        ...
                        <div class="dropdown-item"><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Logincontro/login"><b>Log Out</b></a></div>
                    </div>
                </div>
                    ...
                    if ($myDashboardStatus !== null) {
                        ...
                        foreach ($statusParts as $statusPart) {
                            ...
                            if ($statusPart === "Rewrite") { ?>
                               <!--button class="button button4 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(5) ; toggleActive(this);">Rewrite<span id="Rewritegr" class="urgent-count"></span><i class="fas fa-random" style='font-size:22px'></i></button-->
                    ...
                    if ($myDashboardStatus !== null) {
                        ...
                        foreach ($statusParts as $statusPart) {
                            ...
                            if ($statusPart === "In_Review") { ?>
                                <!-- <button class="button button8 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(2) ; toggleActive(this);"> In Review <span id="InReviewcountgr" class="urgent-count"></span><i class="fa fa-check-square-o"></i></button>
                            ...
                            <div class="dashboard">
                                <?php if (!empty($result)) :
                                    ...
                                    <?php foreach ($matchedClients as $row): ?>
                                        ...
                                        <!-- <!?php if ($row['Gr_ticketValue'] == $id_from_url || $row['Gr_ticketValue'] == 0) : ?> -->
                                        <?php if ($row['gr_Status'] == true) : ?>
                                            ...
                                            <div class="dashboard">
                                                ...
                                                <a href="<?php echo base_url() . 'index.php/GR_Desinger/GR_DashboardControll/updateGRTask/' . $row['id'] ?>" class="popup-trigger">
                                                ...
                                                <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                                    ...
                                                    <a href="<?php echo base_url() . 'index.php/GR_Desinger/GR_DashboardControll/updateGRTask/' . $row['id'] ?>" class="btn btn-primary">
