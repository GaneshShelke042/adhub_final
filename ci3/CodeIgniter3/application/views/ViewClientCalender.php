...
<section class="home-section">
        ...
        ?>
            <button class="add-new-button" style="background-color: #00008B;"><a href="<?php echo base_url() . 'index.php/UpdateClientContro/genrateCalender/' . $id_from_url ?>"><i class="fas fa-plus"></i> Genrate Calender</a>
            </button>
        <?php
        }
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td colspan="2" class="additional-buttons">
                                            <button class="edit">
                                                <a href="<?php echo base_url() . 'index.php/UpdateClientContro/editData/' . $userData['id'] ?>" class="btn btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                            </button>
                                            <button class="delete">
                                                <a href="<?php echo base_url() . 'index.php/UpdateClientContro/deleteData/' . $userData['delet_id'] ?>" class="btn btn-primary">
