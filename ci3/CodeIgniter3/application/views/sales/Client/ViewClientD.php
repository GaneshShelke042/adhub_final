...
<body>
    ...
    <section class="home-section" style=" margin-top: -50%;">
        ...
        <?php if ($myClientStatus === '2' || $myClientStatus === '3') { ?>
            <button class="add-new-button"><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Sales/Sale_TL_ClientControll/addNew_Cr_Client">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="additional-buttons">
                                    ...
                                    <?php if ($myClientStatus === '3') { ?>
                                        <button class="hold"> <a href="<?php echo base_url() . 'index.php/Sales/Sale_TL_ClientControll/editData/' . $userData['id'] ?>" class="btn btn-primary">edit </a></button> &nbsp &nbsp
