        ...
        <div class="row flex-row " id="second-row">
            ...
            <div class="d-flex mt-5 mx-2  flex-column underflex">
                ...
                <div class="col-md-8  mb-5" id="controlpaneloftext">
                    ...
                    <form id="myForm" method="post" action="<?php echo base_url('index.php/DashboardContro/updateSmmTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                        ...
                        <div class="border-top mb-2">
                            ...
                            <div class="d-flex p-3 justify-content-center" id="buttonsss">
                                ...
                                <button class="btn btn-success m-2 " onclick="submitSmmChanges(5, '<?= $tid ?>')">System</button>
                            </div>
                        </div>
                    </form>
