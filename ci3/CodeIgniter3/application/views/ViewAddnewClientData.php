...
<body>
    ...
    if (!empty($addnewclient1)) {
        usort($addnewclient1, 'compareByIdDesc');
    }
    ?>
            ...
            <div class="box-container">
                ...
                <div class="container">
                    ...
                    <div class="search-container">
                        ...
                        <a class="add-new-button" href="http://localhost/adhub/ci3/CodeIgniter3/index.php/User_con/AddnewClient">
                                ...
                                foreach ($addnewclient1 as $userData) {   ?>
                                    <tr>
                                        ...
                                        <td colspan="2" class="additional-buttons">
                                            <button class="edit"> <a href="<?php echo base_url() . 'index.php/User_con/editData/' . $userData['id'] ?>" class="btn btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size:20px"></i> </a></button> &nbsp &nbsp
                                           
                                            <button class="delete" id="deletedata" onclick="confirmDelete('<?php echo base_url() . 'index.php/User_con/deleteData/' . $userData['id'] ?>')">
    <a href="#" class="btn btn-primary" data-toggle="tooltip" title="Delete">
        <i class="fa fa-trash-o" style="font-size:20px"></i>
    </a>
</button>&nbsp &nbsp &nbsp


 <button class="permission"> <a href="<?php echo base_url() . 'index.php/UpdateClientPermissionContro/addNewPermission/' . $userData['id'] ?>" class="btn btn-primary" data-toggle="tooltip" title="Permission"><i class="fa fa-shield" style="font-size:20px"></i> </a> </button>&nbsp &nbsp &nbsp
                                            <button class="details"><a href="<?php echo base_url() . 'index.php/UpdateClientContro/viewCalender/' . $userData['id']; ?>" class="btn btn-primary"><i class="fa fa-eye" style="font-size:20px" data-toggle="tooltip" title="Details"></i></a></button>
    ...
    <script>
        ...
        function confirmAction(id, status) {
            ...
            if (confirm("Are you sure you want to make this action?")) {
                ...
                window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/User_con/status?id=" + id + "&status=" + status;
            }
        }
        ...
        // Encode the formatted date to make it URL-safe
        var hold_Date = encodeURIComponent(formattedDate);
          

            window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/User_con/hold?id=" + id + "&hold=" + hold + "&hold_Date=" + hold_Date;
        }
    }
