...
<body>
    ...
    <script>
        ...
        function openchatbox(str, id, image) {
            ...
            let url = `<?= base_url() ?>index.php/Head_CR_Writer/Head_Cr_Chat/show/${groupid}`;
            console.log(url);
            fetch(url)
                .then(response => {
                    if (!response.ok) {
        ...
        sendmessage.addEventListener('click', () => {
            ...
            console.log(message);
            let url = `<?= base_url() ?>index.php/Head_CR_Writer/Head_Cr_Chat/add`;
            console.log(url);
            // ul.style.zIndex = 99;
        ...
        function deleteMessage(messageId) {
            ...
            fetch(`<?= base_url() ?>index.php/Head_CR_Writer/Head_Cr_Chat/delete/${messageId}`)
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
