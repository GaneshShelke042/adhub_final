...
<body>
    ...
    echo $nameFromUrl = $this->uri->segment(5); ?>
        ...
        <div class="main"> 
            ...
            <P style="margine: left 60px;">Head Content Writer Dashboard</P>
...
foreach ($statusParts as $statusPart) {
    ...
    if ($statusPart === "Advance") { // Change 'Urgent' to the condition you want to match
        ?>
        <button class="button button11 button-with-underline cr box topic-heading" onclick="toggleUrgentButtons(9); toggleActive(this);">Advance<span id="Advance" class="urgent-count"></span><i class="fas fa fa-upload"></i></button>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['cr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                          <a href="<?php echo base_url() . 'index.php/Head_CR_Writer/Head_Cr_dashboardControll/updateTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;">
                                            ...
                                            <a href="<?php echo base_url() . 'index.php/Head_CR_Writer/Head_Cr_dashboardControll/updateTask/' . $row['id'] ?>" class="btn btn-primary">
