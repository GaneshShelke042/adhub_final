...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_CR_Writer/Head_Cr_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_CR_Writer/Head_Cr_ClientControll/clientView">
      ...
      <li>
        <a href="<?php echo base_url() ?>index.php/Head_CR_Writer/Head_Cr_Groupchat/groupview">
          <i class='bx bx-conversation'></i>
          <span class="link_name">Group Chat</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="<?php echo base_url() ?>index.php/Head_CR_Writer/Head_Cr_Groupchat/groupview">Group Chat</a></li>
        </ul>
      </li>
