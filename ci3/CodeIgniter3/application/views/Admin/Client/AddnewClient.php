        ...
        <div class="container">
            <form method="post" name="AddNewClient" action="#">
                <div class="input-field">
                    ...
                    <img src=<?php echo base_url('img/Gallery.png');?> alt="Image Icon" style="width: 120px; border: #2855d1;">
                    </label>
                ...
                <div class="media">
                    ...
                    <img src=<?php echo base_url('img/fb.png');?> alt="Facebook Icon" style="height: 50px;">
                    </a>
                    <a href="#" target="_blank" rel="noopener noreferrer">
                        <img src=<?php echo base_url('img/insta.png');?> alt="Instagram Icon" style="height: 50px;">
                    </a>
                    <a href="#" target="_blank" rel="noopener noreferrer">
                        <img src=<?php echo base_url('img/tw.png');?> alt="Twitter Icon" style="height: 50px;">
                    </a>
                </div>
