                    ...
                    <?php if (!empty($sortedLogoArray)) {
                        foreach ($sortedLogoArray as $key => $value) { ?>
                            <tr> <?php $srno++ ?>
                                ...
                                <td> <button class="btn btn-warning" onclick="deltedata('<?php echo $key ?>','Logo','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-trash-alt'></i> </button> </td>

                                <td> <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#clientdetail" onclick="deleteimage('<?php echo $key ?>','Logo','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-message-alt-edit'></i></button> </td>
                            </tr>
                    ...
                    <?php if (!empty($sortedProspectArray)) {
                        foreach ($sortedProspectArray as $key => $value) { ?>
                            <tr> <?php $srno++ ?>
                                ...
                                <td> <button class="btn btn-warning" onclick="deltedata('<?php echo $key ?>','Prospect','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-trash-alt'></i> </button> </td>


                                <td> <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#clientdetail" onclick="deleteimage('<?php echo $key ?>','Prospect','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-message-alt-edit'></i></button> </td>
                    ...
                    <?php if (!empty($sortedOld_DesignsArray)) {
                        foreach ($sortedOld_DesignsArray as $key => $value) { ?>
                            <tr> <?php $srno++ ?>
                                ...
                                <td> <button class="btn btn-warning" onclick="deltedata('<?php echo $key ?>','Old Designs','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-trash-alt'></i> </button> </td>

                                <td> <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#clientdetail" onclick="deleteimage('<?php echo $key ?>','Old Designs','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-message-alt-edit'></i></button> </td>
                            </tr>
                    ...
                    <?php if (!empty($sortedOthersArray)) {
                        foreach ($sortedOthersArray as $key => $value) { ?>
                            <tr> <?php $srno++ ?>
                                ...
                                <td> <button class="btn btn-warning" onclick="deltedata('<?php echo $key ?>','Others','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-trash-alt'></i> </button> </td>

                                <td> <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#clientdetail" onclick="deleteimage('<?php echo $key ?>','Others','<?php echo $value[0]['Client_id'] ?>')">
                                        <i class='bx bxs-message-alt-edit'></i></button> </td>
                            </tr>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog  modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url() ?>index.php/Admin/Admin_Digitalfile/add/<?= $id ?>" enctype="multipart/form-data" method="post">
        ...
        <script>
            ...
            function deleteimagedata(id) {
                ...
                if (a) {
                    ...
                    let url = `<?= base_url('index.php/Admin/Admin_Digitalfile/deleteparticularimage') ?>`;
                    fetch(url, {
                            method: 'POST',
                            body: formdata
                        }).then(response => {
                ...
                fetch(url, {
                    ...
                    .then(data => {
                        ...
                        data.forEach(element => {
                            ...
                            let v = 0;
                            element.forEach(e => {
                                if (e.file == '.jpeg' || e.file == '.jpg' || e.file == '.png') {
            ...
            function deltedata(name, type, clientid) {
                ...
                // console.log(formdata);
                let url = `<?= base_url('index.php/Admin/Admin_Digitalfile/deletedata') ?>`;
                fetch(url, {
                        method: 'POST',
                        body: formdata
                    })
