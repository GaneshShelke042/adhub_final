...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_ClientControll/clientView">
      ...
      <li>
        <a href="<?php echo base_url() ?>index.php/Admin/Admin_Groupchat/groupview">
          <i class='bx bx-conversation'></i>
          <span class="link_name">Group Chat</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="<?php echo base_url() ?>index.php/Admin/Admin_Groupchat/groupview">Group Chat</a></li>
        </ul>
      </li>
        ...
        <li>
          ...
          <ul class="sub-menu">
            ...
            <?php if ($myPackage_Category === '1' || $myPackage_Category === '2' || $myPackage_Category === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_PackageContro/viewpackage">Package
                  Category</a></li>
            <?php } ?>

            <?php if ($myPackage_GST === '1' || $myPackage_GST === '2' || $myPackage_GST === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_Package_GSTContro/viewpackage">Package
                  GST</a></li>
            <?php } ?>

            <?php if ($myPackage_Service === '1' || $myPackage_Service === '2' || $myPackage_Service === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_PackageServicesController/viewpackage">Package
                  Service</a></li>
            <?php } ?>
