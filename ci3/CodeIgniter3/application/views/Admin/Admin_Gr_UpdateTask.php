...
<body>
    <div class="container-fluid px-3 mb-2 " id="first-row">
        <div class="row justify-content-between p-2" id='headingrow'>
            ...
            <div class="col-sm-2 p-2 text-end">
                <a class="btn btn-primary  p-2" href="<?php echo base_url() . 'index.php/Admin/Admin_dashboardControll/viewDashboard' ?>">Close</a>
            </div>
    ...
    <div class="container-fluid">
        <div class="row flex-row " id="second-row">
            <div class="d-flex mt-5 mx-2  flex-column underflex" id="base">
                ...
                <div class="col-md-8  p-3" id="controlpanel">
                    ...
                    <div class="buttons justify-content-center">
                        ...
                        <button class="btn btn-danger m-1" onclick="digt(<?= $receiveddata[0]->Client_id; ?>)">Digital File</button>
            ...
            <div class="d-flex mt-5 mx-2  flex-column underflex">
                ...
                <form id="myForm" method="post" action="<?php echo base_url('index.php/Admin/Admin_dashboardControll/updateGRTask/') . $receiveddata[0]->id; ?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8  my-5" id="controlpaneloftext">
                        ...
                        <input type="file" id="fileInput" name="imageData" accept="image/*, video/* , application/pdf" multiple />
                    ...
                    <div class="col-md-8  my-5" id="controlpaneloftext">
                        ...
                        <div class="  buttonsofassigning">
                            ...
                            <button class="btn  button m-2 " id="hold">Hold</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <select id="Gr_ticketValue" name="Gr_ticketValue" class="form-select" aria-label="Default select example">
                                                <?php
                                                if (!empty($userResult)) {
                                                    foreach ($userResult as $userData) {
                                                        ...
                                                        if ($userData['role'] === 'Graphic_designer') {
                                                            ...
                                                            $selected = ($userData['id'] == $receiveddata[0]->Gr_ticketValue) ? 'selected' : '';
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-success mx-1" onclick="submitGrChanges(9, <?php echo $tid; ?>)">Changes</button>
                            ...
                            <button class="btn  button m-2 " id="reDesign" onclick="submitGrChanges(2, '<?= $tid ?>')">ReDesign</button>
                            <button class="btn  button m-2 " id="changes" onclick="submitGrChanges(4, '<?= $tid ?>')">Changes</button>
                            <button class="btn  button m-2 " id="approve" onclick="submitGrChanges(6, '<?= $tid ?>')">Approve</button>
                            <button class="btn  button m-2 " id="sendtoclient" onclick="submitGrChanges(7, '<?= $tid ?>')">Send to Client</button>
                            <button class="btn  button m-2 " id="sendtocr" onclick="submitCrChanges(1, '<?= $tid ?>')">Send to Content</button>
                            <button class="btn  button m-2 " id="sendtosmm" onclick="submitBothChanges(<?php echo $tid; ?>)">Send to SMM</button>
                        </div>
    ...
    <script>
        function submitbothclientandgraphics(tid) {
            ...
            document.getElementById('gr_Status').value = 8;
            document.getElementById('smm_Status').value = 1;
