            ...
            <div class="box-container">
                ...
                <div class="container">
                    ...
                    <div class="search-container">
                        ...
                        <button class="add-new-button"><a href="<?php echo base_url() . 'index.php/Admin/Admin_ClientControll/clientPackage/' . $id_from_url ?>">
                                    ...
                                    if ($userData['Client_id'] ==  $id_from_url) { ?>
                                        <tr>
                                            ...
                                            <td colspan="2" class="additional-buttons">
                                                ...
                                                <button class="delete"><a href="<?php echo base_url() . 'index.php/Admin/Admin_ClientControll/deletepkg/' . $userData['id']  . '?Client_id=' . $userData['Client_id']; ?>" class="btn btn-primary"><i class="fa fa-trash-o" style="font-size:20px"></i></button> &nbsp &nbsp
    ...
    <script>
        function confirmAction(id, status, Client_id) {
            ...
            if (confirm("Are you sure you want to make this action?")) {
                ...
                window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_ClientControll/pkg_Status?id=" + id + "&status=" + status + "&Client_id=" + Client_id;
            }
        }
        ...
        function confirmActionHold(id, hold) {
            ...
            if (confirm("Are you sure you want to make this action?")) {
                // If the user confirms, navigate to the specified URL
                window.location.href = "http://localhost/adhub/ci3/CodeIgniter3/index.php/Admin/Admin_ClientControll/hold?id=" + id + "&hold=" + hold;
            }
        }
    </script>
