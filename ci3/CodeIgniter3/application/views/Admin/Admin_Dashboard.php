                    ...
                    <P style="margin: left 60px;">CONTENT WRITER</P>
                        ...
                        <div class="dropdown-container">
                            ...
                            <div class="dropdown-content">
                                ...
                                <div class="dropdown-item"><a href="http://190.168.0.186/adhub/ci3/CodeIgniter3/index.php/Logincontro/login">Log Out</a></div>
                            </div>
                        </div>
...
if ($myDashboardStatus !== null) {
    ...
    foreach ($statusParts as $statusPart) {
        ...
        if ($statusPart === "Urgent") {
            ?>
           <button class="button button2 button-with-underline cr box topic-heading active" onclick="toggleUrgentButtons(1) ; toggleActive(this);"> Urgent<span id="urgentCount" class="urgent-count">3</span> <i class="fas fa-exclamation-circle"></i></button>
...
foreach ($statusParts as $statusPart) {
    ...
    if ($statusPart === "Advance") { // Change 'Urgent' to the condition you want to match
        ?>
        <button class="button button11 button-with-underline cr box topic-heading" onclick="toggleAdvanceButtons(10); toggleActive(this);">Advance<span id="Advance" class="urgent-count"></span><i class="fas fa-arrow-up"></i></button>
                            ...
                            <!-- <php foreach ($result as $row) : ?> -->
                                ...
                                <?php if ($row['cr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                        <a href="<?php echo base_url() . 'index.php/Admin/Admin_dashboardControll/updateTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            ...
                                            <a href="<?php echo base_url() . 'index.php/Admin/Admin_dashboardControll/updateTask/' . $row['id'] ?>" class="btn btn-primary">
...
foreach ($statusParts as $statusPart) {
    ...
    if ($statusPart === "Approved_by_Client") { // Change 'Urgent' to the condition you want to match
        ?>
        <button class="button button5 button-with-underline box topic-heading gr" onclick="toggleGraphicsButtons(8) ; toggleActive(this);">Approved by Client<span id="ApprovedbyClientgr" class="urgent-count"></span><i class="fas fa-check-circle"></i></button>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['gr_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        $borderClass = ($row['cTaskORgCalender'] == 1) ? 'tiket bordered' : 'tiket';
                                        ?>
                                         <a href="<?php echo base_url() . 'index.php/Admin/Admin_DashboardControll/updateGRTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            <!-- Popup content goes here -->
                                            <a href="<?php echo base_url() . 'index.php/Admin/Admin_DashboardControll/updateGRTask/' . $row['id'] ?>" class="btn btn-primary">
                                                <!-- <php include 'UpdateTask1.php' ?> -->
                                            </a>
                                        </div>
                                    </div>
...
foreach ($statusParts as $statusPart) {
    ...
    if ($statusPart === "Approved_by_Hand") { // Change 'Urgent' to the condition you want to match
        ?>
         <button class="button button6 box topic-heading" onclick="toggleSmmButtons(5)">System<i class="fas fa-check-circle"></i></button>
                             ...
                             <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['smm_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        $borderClass = ($row['cTaskORgCalender'] == 1) ? 'tiket bordered' : 'tiket';
                                        ?>
                                       <a href="<?php echo base_url() . 'index.php/Admin/Admin_DashboardControll/updateSmmTask/' . $row['id'] ?>" class="popup-trigger">
                                        ...
                                        <div class="popup" style="display:none;" >
                                            <!-- Popup content goes here -->
                                            <a href="<?php echo base_url() . 'index.php/Admin/Admin_DashboardControll/updateSmmTask/' . $row['id'] ?>" class="btn btn-primary">
