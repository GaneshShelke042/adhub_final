 ...
 echo $name_from_url= $this->session->userdata('name');
  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/HR/HR_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/HR/HR_ClientControll/clientView">
        ...
        <li>
          ...
          <ul class="sub-menu">
            ...
            <?php if ($myPackage_Category === '1' || $myPackage_Category === '2' || $myPackage_Category === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/HR/HR_PackageContro/viewpackage">Package Category</a></li>
            <?php } ?>

            <?php if ($myPackage_GST === '1' || $myPackage_GST === '2' || $myPackage_GST === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/HR/HR_Package_GSTContro/viewpackage">Package GST</a></li>
            <?php } ?>

            <?php if ($myPackage_Service === '1' || $myPackage_Service === '2' || $myPackage_Service === '3') { ?>
              <li><a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/HR/HR_PackageServicesController/viewpackage">Package Service</a></li>
            <?php } ?>
