 ...
 echo ("(Head Smm)")
  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_SMM/Head_Smm_dashboardControll/viewDashboard">
      ...
      <?php if ($myClientStatus === '1' || $myClientStatus === '2' || $myClientStatus === '3') { ?>
        <li>
          <a href="http://localhost/adhub/ci3/CodeIgniter3/index.php/Head_SMM/Head_Smm_ClientControll/clientView">
