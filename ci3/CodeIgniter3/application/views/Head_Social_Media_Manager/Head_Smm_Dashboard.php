...
<body>
    ...
    echo $nameFromUrl = $this->uri->segment(5); ?>
        ...
        <section class="main-content">
            <label class="section-heading">Head SMM Dashboard</label>
                            ...
                            <?php foreach ($matchedClients as $row): ?>
                                ...
                                <?php if ($row['smm_Status'] == true) : ?>
                                    <div class="dashboard">
                                        ...
                                        ?>
                                        <a href="<?php echo base_url() . 'index.php/Head_SMM/Head_Smm_dashboardControll/updateSmmTask/' . $row['id'] ?>" class="popup-trigger">
                                        <button class="<?php echo $borderClass; ?>" onclick="togglePopup(this , <?php echo $row['id']; ?>)" data-smm-status="<?php echo $row['smm_Status']; ?>">
                                        <img src="<?php echo base_url()?>Image/PackageServies/<?php echo $row['imageLogo']; ?>"  style="height: 40px; width: 60px; border-radius: 35px;  " >
                                        <?php echo $row['id'] ?><br>
                                        ...
                                        <div class="popup" style="display:none;" id="togglePopup<?php echo $row['id'] ?>">
                                            ...
                                            <a href="<?php echo base_url() . 'index.php/Head_SMM/Head_Smm_dashboardControll/updateSmmTask/' . $row['id'] ?>" class="btn btn-primary">
