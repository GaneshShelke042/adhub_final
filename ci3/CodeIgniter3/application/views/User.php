        ...
        <form action="submit">
            ...
            <div class="fields">
                ...
                <div class="input-field">
                    ...
                    <input type="text" placeholder="Enter your Name" id="ownername" required>
                </div>

                <div class="input-field">
                    <label>Calendar Type</label>
                    <input type="number" placeholder="Enter calendar type" required>
                </div>
                ...
                <div class="input-field">
                    ...
                    <input type="text" placeholder="Enter reference name" id="reference" required>
                </div>

                <div class="input-field">
                    <label>Sales Executive</label>
                    <input type="text" placeholder="Enter sales executive name" id="salesExecutive" required>
                </div>
            </div>
