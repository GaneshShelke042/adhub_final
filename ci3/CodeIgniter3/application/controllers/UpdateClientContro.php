...
class UpdateClientContro extends CI_Controller
{
    ...
    function viewCalender()
    {
        ...
        $this->load->view('UpdateClient.php', $data1);
    }
    ...
    public function genrateCalender()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('GenrateCalender.php', $data1);
        } else {
            ...
            redirect(base_url() . 'index.php/UpdateClientContro/ViewClientCalender/' . $data1['client_id']);
        }
    }
    ...
    function viewClientCalender()
    {
        ...
        $this->load->view('SideHeadFoot.php');
        $this->load->view('ViewClientCalender.php', $data);
    }
    ...
    //     $this->load->view('SideHeadFoot.php');
    //     $this->load->model('GenrateCalender');
    //     $result = $this->GenrateCalender->editCalender($userData);
    ...
    //     $this->form_validation->set_rules('numberOfDays', 'number_of_days', 'required');
    //     if ($this->form_validation->run() == false) {
    //         $this->load->view('EditGenrateCalender.php', $data);
    //     } else {
    //         $data = array();
    //         //Databse field                       //  form field
    //         $data['start_date'] = $this->input->post('startDate');
    //         $data['number_of_days'] = $this->input->post('numberOfDays');
    //         $data['service']  = implode(',', $this->input->post('serviceName'));
    //         $data['name'] = implode(',', $this->input->post('Name'));
    //         $data['details'] = implode(',', $this->input->post('details'));
    //         $data['additional_info'] = implode(',', $this->input->post('additionalInfo'));
    //         $data['date_formatted'] = implode(',', $this->input->post('formattedDate'));

    //         $this->GenrateCalender->updatCalender($userData, $data);
    //         redirect(base_url() . 'index.php/UpdateClientContro/viewClientCalender');
    ...
    //         // Iterate through the combinedArray and updatedticket to update task_name if needed
    //         foreach ($combinedArray as &$combinedEntry) {
    //             if (empty($combinedEntry['task_name'])) {
    //                 foreach ($updatedticket as $updatedEntry) {
    //                     if ($combinedEntry['deadline_datetime'] == $updatedEntry['deadline_datetime']) {
    //                         print_r($updatedEntry);
    //                         //   echo $updatedEntry['id'];
    //                         $this->GenrateCalender->deletedashboardticket($updatedEntry['id']);
    //                         break;
    //                     }
    //                 }
    //             }
    ...
    //         redirect(base_url() . 'index.php/UpdateClientContro/viewClientCalender/' . $data['correctdata']['Client_id']);
    //     }
    // }
