...
class Admin_UpdateClientContro extends CI_Controller
{
    ...
    function viewCalender()
    {
        ...
        $this->load->view('Admin/Admin_UpdateClient.php', $data1);
    }
    ...
    public function genrateCalender()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/Admin/Admin_UpdateClientContro/viewClientCalender/' . $data['client_id']);
        }
    }
    ...
    function editData()
    {
        ...
        if ($this->form_validation->run() == false) {
            //$this->load->view('SideHeadFoot.php');
            $this->load->view('Admin/Admin_Edit_Calender.php', $data);
        } else {
            $edit = array(
            ...
            redirect(base_url('index.php/Admin/Admin_UpdateClientContro/viewClientCalender/') . $data['correctdata']['Client_id']);
        }
    }
    ...
    function viewClientCalender()
    {
        ...
        $this->load->view('Admin/Admin_ViewClientCalender.php', $data);
    }
    ...
    function deleteData($userData)
    {
        ...
        // echo  $userData;
        if (empty($result)) {
            redirect(base_url() . 'index.php/Admin/Admin_UpdateClientContro/viewClientCalender');
        }
