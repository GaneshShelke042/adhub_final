...
class Admin_Groupchat extends CI_Controller
{
    ...
    public function Manage()
    {
        ...
        $this->load->view('Admin/Groupchat/manage', $newdata);
    }
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('Admin/Groupchat/add2', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                redirect(base_url() . 'index.php/Admin/Admin_Groupchat/Manage');
    ...
    public function View()
    {
        ...
        $this->load->view('Admin/Groupchat/viewgroup', $data);
    }
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['userResult'] = $this->UserModel->viewData();
            $data['image'] = $this->Groupchatmodel->viewdatabygroupid($id);
            $this->load->view('Admin/Groupchat/updatemember', $data);
        } else {
            $config['upload_path'] = './chatprofile/';
            $config['allowed_types'] = 'jpg|jpeg|png';
            $config['max_size'] = 11264;
