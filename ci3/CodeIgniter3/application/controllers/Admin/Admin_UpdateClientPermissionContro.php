...
class Admin_UpdateClientPermissionContro extends CI_Controller
{
    ...
    public function Admin_UpdateClientPermissionContro() {
        ...
        $this->load->view('Admin/Admin_SideHeadFoot', $data);
        ...
        $this->load->view('Admin/Admin_UpdateClientPermission.php', $data);
    }
