...
class Admin_Digitalfile extends CI_Controller
{
    public $upload;
    ...
    public function view()
    {
        ...
        $this->load->view('Admin/Admin_viewDigitalfile', $value);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($_FILES['file']['name'][0])) {
                ...
                redirect(base_url() . 'index.php/Admin/Admin_Digitalfile/view/' . $id);
            } else {
