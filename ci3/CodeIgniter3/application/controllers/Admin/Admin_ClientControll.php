...
class Admin_ClientControll extends CI_Controller
{
    ...
    function clientView()
    {
        ...
        $this->load->view('Admin\Client\ViewClientD.php', $data1);
    ...
    function addNew_Cr_Client()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Admin\Client\AddnewClient.php', $data);
        } else {
            ...
            redirect(base_url() . '/index.php/Admin/Admin_ClientControll/clientView');
    ...
    function editData($userData)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Admin\Client\EditAddnewClientData', $data);
        } else {
    ...
    function clientPackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Admin/Client_package.php', $data);
        } else {
            $item = array();
    ...
    function viewClient_Package()
    {
        ...
        $this->load->view('Admin/ViewClient_Package.php', $data);
    }
    ...
    public function pkg_Status()
    {
        if (isset($_REQUEST['status'])) {
            ...
            return redirect('index.php/Admin/Admin_ClientControll/clientView/' . $id);
        }
    }
    ...
    function deletepkg($userData)
    {
        ...
        redirect(base_url() . 'index.php/Admin/Admin_ClientControll/clientView/' . $id);
    }
}
