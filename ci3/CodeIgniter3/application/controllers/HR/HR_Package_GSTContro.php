...
class HR_Package_GSTContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('HR\Package GST\AddNewPackageGST.php');
        } else {
            ...
            redirect(base_url() . 'index.php/HR/HR_Package_GSTContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('HR\Package\Package GST\ViewPackageGST.php', $data);
    }
