...
class HR_PackageContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('HR\Package\Package Category\NewPackageCategory.php');
        } else {
            ...
            redirect(base_url() . 'index.php/HR/HR_PackageContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('HR\Package\Package Category\ViewPackageCategory.php', $data);
    }
    ...
    function updateData($userData) {
        ...
        if ($this->input->post()) {
            ...
            $this->load->view('HR\Package\Package Category\EditPackageCategory', $data);
        }
    }
