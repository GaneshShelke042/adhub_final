...
class Head_Gr_ClientControll extends CI_Controller
{

    public $db;
    public $form_validation;
    public $Head_Gr_ClientModel;
    ...
    function clientView()
    {
        ...
        $this->load->model('Head_GR_DesingerModel/Head_Gr_ClientModel');
        $addnewclient1 = $this->Head_Gr_ClientModel->viewClient();
        $data1 = array();
        ...
        $this->load->view('Head_GR_Desinger/Client/ViewClientD.php', $data1);
