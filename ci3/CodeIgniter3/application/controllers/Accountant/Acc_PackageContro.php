...
class Acc_PackageContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Accountant\Package\Package Category\NewPackageCategory.php');
        } else {
            ...
            redirect(base_url() . 'index.php/Accountant/Acc_PackageContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('Accountant\Package\Package Category\ViewPackageCategory.php', $data);
    }
    ...
    function updateData($userData) {
        ...
        if ($this->input->post()) {
            ...
            $this->load->view('Accountant\Package\Package Category\EditPackageCategory', $data);
        }
    }
