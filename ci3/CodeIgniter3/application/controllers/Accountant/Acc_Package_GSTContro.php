...
class Acc_Package_GSTContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Accountant\Package GST\AddNewPackageGST.php');
        } else {
            ...
            redirect(base_url() . 'index.php/Accountant/Acc_Package_GSTContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('Accountant\Package\Package GST\ViewPackageGST.php', $data);
    }
