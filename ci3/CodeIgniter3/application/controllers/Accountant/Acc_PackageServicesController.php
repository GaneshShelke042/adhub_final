...
class Acc_PackageServicesController extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('Accountant\Package\Package Services\AddPackageServies.php', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                echo $error['err'];
                $this->load->view('Accountant\Package\Package Services\AddPackageServies.php');
            }
            ...
            redirect(base_url() . 'index.php/Accountant/Acc_PackageServicesController/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('Accountant\Package\Package Services\ViewPackageServices.php', $data);
    }
    ...
    function updateData($userData)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Accountant\Package\Package Services\EditPackageServices.php', $data);
        } else {
