...
class Sale_TL_PackageContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/Sales/Sale_TL_PackageContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('sales\Package\Package Category\ViewPackageCategory.php', $data);
    }
    ...
    function updateData($userData) {
        ...
        if ($this->input->post()) {
            ...
            $this->load->view('sales\Package\Package Category\EditPackageCategory', $data);
        }
    }
