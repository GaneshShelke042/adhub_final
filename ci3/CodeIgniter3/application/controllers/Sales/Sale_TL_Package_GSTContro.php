...
class Sale_TL_Package_GSTContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('sales\Package GST\AddNewPackageGST.php');
        } else {
            ...
            redirect(base_url() . 'index.php/Sales/Sale_TL_Package_GSTContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('sales\Package\Package GST\ViewPackageGST.php', $data);
    }
