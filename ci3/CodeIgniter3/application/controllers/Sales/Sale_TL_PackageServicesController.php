...
class Sale_TL_PackageServicesController extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->view('sales\Sales_SideHeadFoot.php', $data);
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('sales\Package\Package Services\AddPackageServies.php', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                echo $error['err'];
                $this->load->view('sales\Package\Package Services\AddPackageServies.php');
            }
            ...
            redirect(base_url() . 'index.php/Sales/Sale_TL_PackageServicesController/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('sales\Package\Package Services\ViewPackageServices.php', $data);
    }
    ...
    function updateData($userData)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('sales\Package\Package Services\EditPackageServices.php', $data);
        } else {
