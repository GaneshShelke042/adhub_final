...
class Head_TL_PackageServicesController extends CI_Controller
{
...
//   $this->load->view('Head_TeamLead\Head_TL_SideHeadFoot.php', $data);
  ...
  // ^^^^^^^^^^^^^^^^^^^^^^^ This is for Permission  ^^^^^^^^^^^^^^^^^^^^^^
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/Head_Team_Lead/Head_TL_PackageServicesController/viewpackage');
        }
    }
...
//   // ^^^^^^^^^^^^^^^^^^^^^^^ This is for Permission  ^^^^^^^^^^^^^^^^^^^^^^
        ...
        // $this->load->view('SideHeadFoot.php');
        $this->load->view('Head_TeamLead\Package\Package Services\ViewPackageServices.php', $data);
    }
    // $userData
