...
class Head_TL_Package_GSTContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        $this->load->view('Head_TeamLead\Package\Package GST\AddNewPackageGST.php');
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/Head_Team_Lead/Head_TL_Package_GSTContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('Head_TeamLead\Package\Package GST\ViewPackageGST.php', $data);
    }
