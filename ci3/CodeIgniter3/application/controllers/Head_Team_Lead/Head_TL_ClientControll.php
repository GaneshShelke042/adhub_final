...
class Head_TL_ClientControll extends CI_Controller
{
    ...
    function clientView()
    {
        ...
        $this->load->view('Head_TeamLead\Client\ViewClientD.php', $data1);
    ...
    function addNew_Cr_Client()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Head_TeamLead\Client\AddnewClient.php');
        } else {
            ...
            // ^^^^^^^^^^^^^^^^^^^^^^^ THis is  for GenrateCalender  ^^^^^^^^^^^^^^^^^^^^^^
                ...
                redirect(base_url() . 'index.php/Head_Team_Lead/Head_TL_ClientControll/clientView');
