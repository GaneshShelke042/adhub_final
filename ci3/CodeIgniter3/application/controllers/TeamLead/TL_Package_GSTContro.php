...
class TL_Package_GSTContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Admin\Package GST\AddNewPackageGST.php');
        } else {
            ...
            redirect(base_url() . 'index.php/TeamLead/TL_Package_GSTContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('TeamLead\Package\Package GST\ViewPackageGST.php', $data);
    }
