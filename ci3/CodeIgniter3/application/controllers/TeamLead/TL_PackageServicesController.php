...
class TL_PackageServicesController extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->view('TeamLead\TL_SideHeadFoot.php', $data);
    ...
    function addnewpackage()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('TeamLead\Package\Package Services\AddPackageServies.php', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                echo $error['err'];
                $this->load->view('TeamLead\Package\Package Services\AddPackageServies.php');
            }
            ...
            redirect(base_url() . 'index.php/TeamLead/TL_PackageServicesController/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('TeamLead\Package\Package Services\ViewPackageServices.php', $data);
    }
    ...
    function updateData($userData)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('TeamLead\Package\Package Services\EditPackageServices.php', $data);
        } else {
