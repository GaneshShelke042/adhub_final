...
class TL_PackageContro extends CI_Controller
{
    ...
    function addnewpackage()
    {
        ...
        // $this->load->view('Sales\Package\Package Category\NewPackageCategory.php');

        $this->load->model('PackageCategoryModel');

        $this->form_validation->set_rules('name', 'name', 'required');
        if ($this->form_validation->run() == false) {
            $this->load->view('TeamLead\Package\Package Category\NewPackageCategory.php');
        } else {
            ...
            redirect(base_url() . 'index.php/TeamLead/TL_PackageContro/viewpackage');
        }
    }
    ...
    function viewpackage()
    {
        ...
        $this->load->view('TeamLead\Package\Package Category\ViewPackageCategory.php', $data);
    }
    ...
    function updateData($userData) {
        ...
        if ($this->input->post()) {
            ...
            $this->load->view('TeamLead\Package\Package Category\EditPackageCategory', $data);
        }
    }
