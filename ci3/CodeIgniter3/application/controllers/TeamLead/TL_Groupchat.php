...
class TL_Groupchat extends CI_Controller
{
    ...
    public function groupview()
    {
        ...
        $this->load->view('TeamLead/Groupchat/group', $data);
    }
    ...
    public function Manage()
    {
        ...
        $this->load->view('TeamLead/Groupchat/manage', $newdata);
    }
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('TeamLead/Groupchat/add2', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                redirect(base_url() . 'index.php/TeamLead/TL_Groupchat/Manage');
    ...
    public function View()
    {
        ...
        $this->load->view('TeamLead/Groupchat/viewgroup', $data);
    }
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['userResult'] = $this->UserModel->viewData();
            $data['image'] = $this->Groupchatmodel->viewdatabygroupid($id);
            $this->load->view('TeamLead/Groupchat/updatemember', $data);
        } else {
            $config['upload_path'] = './chatprofile/';
            $config['allowed_types'] = 'jpg|jpeg|png';
            $config['max_size'] = 11264;
