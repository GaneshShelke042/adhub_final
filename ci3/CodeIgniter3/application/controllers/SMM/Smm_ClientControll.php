...
class Smm_ClientControll extends CI_Controller
{

    public $db;
    public $form_validation;
    public $Smm_ClientModel;
    ...
    function clientView()
    {
        ...
        $this->load->model('SmmModel/Smm_ClientModel');
        $addnewclient1 = $this->Smm_ClientModel->viewClient();
        $data1 = array();
        ...
        $this->load->view('Social_Media_Manager\Client\ViewClientD.php', $data1);
    ...
    function addNew_Smm_Client()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Social_Media_Manager\Client\AddnewClient.php');
        } else {
            ...
            $this->Smm_ClientModel->insertClient($data);
