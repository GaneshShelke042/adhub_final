...
class Smm_Groupchat extends CI_Controller
{
    ...
    public function groupview()
    {
        ...
        // echo"<pre>";
        // print_r($data['users']);
        $this->load->view('Social_Media_Manager/Groupchat/group', $data);
    }
    ...
    public function Manage()
    {
        ...
        $this->load->view('Social_Media_Manager/Groupchat/manage', $newdata);
    }
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('Social_Media_Manager/Groupchat/add2', $data);
        } else {
            ...
            if ($this->upload->do_upload('image')) {
                ...
                redirect(base_url() . 'index.php/SMM/Smm_Groupchat/Manage');
    ...
    public function View()
    {
        ...
        $this->load->view('Social_Media_Manager/Groupchat/viewgroup', $data);
    }
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['userResult'] = $this->UserModel->viewData();
            $data['image'] = $this->Groupchatmodel->viewdatabygroupid($id);
            $this->load->view('Social_Media_Manager/Groupchat/updatemember', $data);
        } else {
            $config['upload_path'] = './chatprofile/';
            $config['allowed_types'] = 'jpg|jpeg|png';
            $config['max_size'] = 11264;
