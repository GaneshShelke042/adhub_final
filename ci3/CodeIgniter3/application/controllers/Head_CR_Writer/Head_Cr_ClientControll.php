...
class Head_Cr_ClientControll extends CI_Controller
{

    public $db;
    public $form_validation;
    public $Head_Cr_ClientModel;
    ...
    function clientView()
    {
        ...
        $this->load->model('Head_CR_WriterModel/Head_Cr_ClientModel');
        $addnewclient1 = $this->Head_Cr_ClientModel->viewClient();
        $data1 = array();
        ...
        $this->load->view('Head_CR_Writer/Client/ViewClientD.php', $data1);
    ...
    function addNew_Cr_Client()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('Head_CR_Writer\Client\AddnewClient.php');
        } else {
            ...
            $this->Head_Cr_ClientModel->insertClient($data);
            ...
            redirect(base_url() . 'index.php/Head_CR_Writer/Head_Cr_ClientControll/clientView');
