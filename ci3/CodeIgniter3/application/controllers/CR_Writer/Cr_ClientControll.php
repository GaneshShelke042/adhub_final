...
class Cr_ClientControll extends CI_Controller
{
    ...
    function clientView()
    {
        ...
        $addnewclient1 = $this->Cr_ClientModel->viewClient();
        $data1 = array();
        ...
        $this->load->view('CR_Writer/Client/ViewClientD.php', $data1);
        ...
        // // Fetch clients with corresponding permissions
        // $clientsWithPermission = $this->UpdateClientPermissionModel->viewClientWithPermission();
        
        // $data = array(
        //     'clientsWithPermission' => $clientsWithPermission
        // );
    
        // $this->load->view('CR_Writer/Client/ViewClientD.php', $data);
    ...
    function addNew_Cr_Client()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('CR_Writer\Client\AddnewClient.php');
        } else {
            ...
            // ^^^^^^^^^^^^^^^^^^^^^^^ THis is  for GenrateCalender  ^^^^^^^^^^^^^^^^^^^^^^
                ...
                redirect(base_url() . 'index.php/CR_Writer/Cr_ClientControll/clientView');
    ...
    function editData($userData)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('CR_Writer/Client/EditAddnewClientData', $data);
        } else {
