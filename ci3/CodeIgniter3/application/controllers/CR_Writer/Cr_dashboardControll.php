...
class Cr_dashboardControll extends CI_Controller
{
    ...
    function viewDashboard()
    {
        ...
        $this->load->view('CR_Writer/Cr_Dashboard.php', $data1);
    }
    ...
    public function updateTask()
    {
        ...
        if (!empty($data['receiveddata'][0]->Client_id)) {
            ...
            if (isset($data["que"][0]["question"]) && isset($data["ans"][0]["ans"])) {
                ...
                echo "Language Forms Not Filled.";
            }
            ...
            if (isset($data["54que"][0]["question"]) && isset($data["54ans"][0]["ans"])) {
                ...
                echo "54 Question Forms Not Filled.";
            }
            ...
            if (isset($data["painpointque"][0]["question"]) && isset($data["painpointans"][0]["ans"])) {
                ...
                echo "Painpoint Forms Not Filled.";
            }
            // echo "<pre>";
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('CR_Writer\Cr_UpdateTask.php', $data); // Pass data to the view
