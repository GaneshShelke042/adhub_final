...
class Gr_dashboardControll extends CI_Controller
{
    ...
    function viewDashboard()
    {
        ...
        $this->load->view('GR_Desinger\Gr_Dashboard.php', $data1);
    }
    ...
    public function updateGRTask()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('GR_Desinger\Gr_UpdateTask.php', $data); // Pass data to the view
    ...
    function acceptTicket()
    {
        ...
        // Update the task
        if ($this->UpdateTaskModel->acceptGrTickets($tid, $Gr_ticketValue)) {
