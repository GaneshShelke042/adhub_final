...
class Gr_ClientControll extends CI_Controller
{

    public $db;
    public $form_validation;
    public $Gr_ClientModel;
    ...
    function clientView()
    {
        ...
        $this->load->model('GR_DesingerModel/Gr_ClientModel');
        $addnewclient1 = $this->Gr_ClientModel->viewClient();
        $data1 = array();
        ...
        $this->load->view('GR_Desinger/Client/ViewClientD.php', $data1);
